...
from drawables import Line, DrawLine, Polygon, DrawPolygon
...
class Drawer(object):
    ...
    def __init__(self):
        ...
        self.__action = DrawLine(self.__primary, self.__secondary, True)
    ...
    def on_mouse_release(self, widget, event):
        ...
        if (ret is not None):
            ...
            self.__action = self.__selected_action(self.__primary, self.__secondary, True)

        self.__draw_area.queue_draw()

    def on_mouse_press(self, widget, event):
        self.__action.on_mouse_press(Coords(event.x, event.y),
                                     event.button == Gdk.BUTTON_PRIMARY,
                                     event.button == Gdk.BUTTON_SECONDARY)
